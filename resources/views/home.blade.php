          ...
          > --}}
            <div class="card">
              ...
              <div class="footer-card">
                <a href="#"
                  ><i class="far fa-map-marked-alt"></i> <span
                    >Tenggarang</span
                  ></a
                >
              ...
              <div class="footer-card">
                <div class="flex-footer-card">
                  <div class="col-card-ft">
                    <a href="#"
                      ><i class="far fa-home"></i> <span>Sepatan</span></a
                    >
                  </div>
                  <div class="col-card-ft">
                    <a href="#"
...
$('#carousel-2').owlCarousel({
  ...
  dots: true,
  loop: false,
  navText: ["<img src='https://cdn.spillmoment.id/img/arrow-left.png'>","<img src='https://cdn.spillmoment.id/img/arrow-right.png'>"],
  responsive: {
      0: { 
        items: 1, 
        nav: false
