...
@section('title', 'Admin - Halaman Edit Speaker')
        ...
        <div class="col-12 mb-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3">
                <div class="d-block mb-4 mb-md-0">
                    ...
                    <h2 class="h4 mt-1">Form Edit Speaker</h2>
                </div>
            </div>
            ...
            <div class="card border-light shadow-sm components-section">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.speaker.update', [$speaker->id]) }}" method="post"
                            ...
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        name="name" id="name" value="{{$speaker->name}}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email"
                                        ...
                                        name="email" id="email" value="{{$speaker->email}}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number"
                                        ...
                                        name="phone" id="phone" value="{{$speaker->phone}}"
                            ...
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        name="competence" id="competence" value="{{$speaker->competence}}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        name="position" id="position" value="{{$speaker->position}}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="address"
                                        ...
                                        id="address" rows="3"
                                        placeholder="Masukkan Alamat">{{$speaker->address}}</textarea>
                                    <div class="invalid-feedback">
