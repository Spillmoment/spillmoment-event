<div class="btn-group">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ route('admin.speaker.show', $item->id) }}"><span
                class="fas fa-eye mr-2"></span>Detail</a>
        <a class="dropdown-item" href="{{ route('admin.speaker.edit', $item->id) }}"><span
                class="fas fa-edit mr-2"></span>Sunting</a>
        <form action="{{ route('admin.speaker.destroy', $item->id) }}" method="POST">
            @csrf
            @method('DELETE')
