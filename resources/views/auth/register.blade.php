                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="auth-body">
                                ...
                                <div class="auth-input-box">
                                    <input type="text" name="name" id="nama" placeholder="nama kamu?" autofocus
                                        value="{{ old('name') }}" />
                                </div>
                                @error('name')
                                ...
                                <div class="auth-input-box">
                                    <input type="email" name="email" id="email"
                                        placeholder="Masukan alamat email yang ada" value="{{ old('email') }}" />
                                </div>
                                @error('email')
                                <small style="color: rgb(255, 78, 78); font-weight: bold">{{ $message }}</small>
                                @enderror
                                ...
                                <div class="auth-input-box">
                                    <input type="number" name="phone" id="phone" placeholder="contoh: +6208974xxxx"
                                        value="{{ old('phone') }}" />
                                </div>
                                @error('phone')
                                <small style="color: rgb(255, 78, 78); font-weight: bold">{{ $message }}</small>
