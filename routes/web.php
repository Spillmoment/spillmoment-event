...
Route::prefix('event')
	...
	->group(function () {
		...
		Route::get('kategori-event', [EventController::class, 'kategoriGetAutocomplete'])->name('kategori.getAutocomplte');
		Route::get('partner-event', [EventController::class, 'partnerGetAutocomplete'])->name('partner.getAutocomplte');
